!function() {
    "use strict";
    (t => {
        const {screen: {width: e, height: a}, navigator: {language: r}, location: n, localStorage: i, document: c, history: o} = t
          , {hostname: s, href: u} = n
        ...
        const m = "data-"
          ...
          , E = () => !h || i && i.getItem("umami.disabled") || v && !w.includes(s)
          , L = async (t, e="event") => {
            if (E())
                return;
            const a = {
        ...
        let K, R, B = U(u), D = d !== s ? d : "", _ = c.title;
        if (y && !E()) {
            ( () => {
                const t = (t, e, a) => {
                    const r = t[e];
                    return (...e) => (a.apply(null, e),
                    r.apply(t, e))
                }
                ;
            ...
            c.addEventListener("click", (async t => {
                    ...
                    return a(r);
                {
                    ...
                    if (c)
                        ...
                        } else if ("BUTTON" === i.tagName)
                            return a(i)
                }
            }
            ), !0);
            const t = () => {
                "complete" !== c.readyState || R || ($(),
                R = !0)
            }
            ;
            c.addEventListener("readystatechange", t, !0),
            t()
        }
    }
    )(window)
